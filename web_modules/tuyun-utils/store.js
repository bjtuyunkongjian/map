  ...
  return function wrapper(Base) {
    ...
    return (
      (_a = /** @class */ (function(_super) {
        ...
        WrapperComponent.prototype.componentWillMount = function() {
          ...
          if (process.env.NODE_ENV != 'production') {
            if (this.store._opts.debug) {
              ...
              console.log(
                WrapperComponent.displayName + ' will mount \uD83D\uDE80'
              );
            }
          }
        };
        ...
        WrapperComponent.prototype.componentWillUpdate = function(
          nextProps,
          nextState,
          nextContext
        ) {
          _super.prototype.componentWillUpdate &&
            _super.prototype.componentWillUpdate.call(
              this,
              nextProps,
              nextState,
              nextContext
        ...
        WrapperComponent.prototype.componentDidUpdate = function(
          ...
          _super.prototype.componentDidUpdate &&
            _super.prototype.componentDidUpdate.call(
              this,
              prevProps,
              prevState,
              prevContext

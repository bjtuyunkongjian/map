...
查看 pdf 版本（当前最高版本: 2.4.18）接口文档：[点此下载](http://47.110.135.245:8084/docs/api.pdf)
...
```html
<!-- 地图引入文件 47.110.135.245:8084 -->
<script src="http://47.110.135.245:8084/third-party-api/ty-map-development.2.4.18.js"></script>
<script src="http://47.110.135.245:8084/third-party-api/ty-map-production.2.4.18.js"></script>
```

### 下载第三方接口的 js 代码

您可以从 <http://47.110.135.245:8084/third-party-api/ty-map-development.2.4.18.js> 或者 <http://47.110.135.245:8084/third-party-api/ty-map-production.2.4.18.js> 上下载图云空间第三方接口的对应版本到本地。其中 2.4.18 为版本号。然后通过

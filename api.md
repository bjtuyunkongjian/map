...
查看 pdf 版本（当前最高版本: 2.4.13）接口文档：[点此下载](http://47.110.135.245:8080/docs/api.pdf)
...
<html lang="en" style="width: 100%; height: 100%;">
  ...
  <body style="width: 100%; height: 100%;">
    ...
    <script src="http://ip:host/dir/ty-map-development.2.4.13.js"></script>
    <script>
...
其中 TyMap 是 ty-map.2.4.13.js 中导出的唯一一个类。由于是 script 标签的形式引入，TyMap 也是一个全局对象。
...
```html
<!-- 地图引入文件 -->
<script src="http://47.110.135.245:8080/third-party-api/ty-map-development.2.4.13.js"></script>
<script src="http://47.110.135.245:8080/third-party-api/ty-map-production.2.4.13.js"></script>
```

### 下载第三方接口的 js 代码

您可以从 <http://47.110.135.245:8080/third-party-api/ty-map-development.2.4.13.js> 或者 <http://47.110.135.245:8080/third-party-api/ty-map-production.2.4.13.js> 上下载图云空间第三方接口的对应版本到本地。其中 2.4.13 为版本号。然后通过

```html
<script src="dirname/ty-map-development.2.4.13.js"></script>
```

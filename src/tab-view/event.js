...
const EventName = {
  ...
  changeCaseDensity: 'change:caseDensity', // 更改案件平均密度
  //警情
  updatePosituationChart: 'update:poaituationChart', // 更新案件面板中图标数据
  changePosituationDistribution: 'change:posituationDistribution', // 更改案件选中选项
  changePosituationMulti: 'change:posituationMulti', // 更改案件多发区域
  changePosituationTendency: 'change:posituationTendency', // 更改案件趋势
  changePosituationDensity: 'change:posituationDensity' // 更改案件平均密度
};
